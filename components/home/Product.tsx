      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-2'>
        {
          products.slice(0,4).map((product : any) =>(
            <ProductCard key={product.id} title={product.title} image={product.image} price={product.price} descripton={product.description} id={product.id} rating={product.rating} />
          ))
         }
      </div>
